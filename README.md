...
## ⚠️ WARNING: Concept Only (Does NOT Run)
This is a conceptual sketch (PoC). 
- **No project files**: Visual Studio solution/project files are not included.
- **Does not compile**: The code is incomplete by design.
- **Just enjoy the vibes**: Focus on the class structure and dependencies.
